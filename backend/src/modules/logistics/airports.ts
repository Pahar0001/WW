  ...
  MOW: [
    {
      ...
      parking: [
        { title: 'Официальные парковки аэропорта', url: 'https://www.svo.aero/ru/parkings', note: 'У терминалов — короткие и дорогие. На несколько дней берут долгосрочную: она дальше, до терминала идёт бесплатный шаттл.' },
        { title: 'Бронирование места заранее', url: 'https://www.svo.aero/ru/parkings', note: 'Забронированное место почти всегда дешевле подъезда «с улицы» и гарантирует, что оно будет.' },
      ],
    },
    {
      ...
      parking: [
        { title: 'Официальные парковки аэропорта', url: 'https://www.dme.ru/passengers/services/parking/', note: 'Есть крытые и открытые; долгосрочные дешевле в пересчёте на сутки, до терминала — шаттл.' },
      ],
    },
    {
      ...
      parking: [
        { title: 'Официальные парковки аэропорта', url: 'https://www.vnukovo.ru/for-passengers/parking/', note: 'Ближние стоянки у терминала, долгосрочная — отдельной зоной с бесплатным подвозом.' },
      ],
    },
  ],
  LED: [
    {
      ...
      parking: [
        { title: 'Официальные парковки аэропорта', url: 'https://pulkovoairport.ru/transport/parking/', note: 'Привокзальные — для встречающих, для поездки на неделю берут долгосрочную.' },
      ],
    },
  ],
  SVX: [
    {
      ...
      parking: [{ title: 'Парковки аэропорта Кольцово', url: 'https://svx.aero/', note: 'Есть краткосрочные у терминалов и долгосрочная зона.' }],
    },
  ],
  KZN: [
    {
      ...
      parking: [{ title: 'Парковки аэропорта Казань', url: 'https://kazan.aero/', note: 'Долгосрочная парковка дешевле привокзальной при поездке от нескольких дней.' }],
    },
  ],
  OVB: [
    {
      ...
      lateNight: 'Ночью только такси.',
      parking: [{ title: 'Парковки аэропорта Толмачёво', url: 'https://tolmachevo.ru/', note: 'Первые минуты обычно бесплатны — этого хватает, чтобы высадить пассажира.' }],
    },
  ],
  AER: [
    {
      ...
      parking: [{ title: 'Парковки аэропорта Сочи', url: 'https://aer.aero/', note: 'В высокий сезон места разбирают — бронируйте заранее.' }],
    },
  ],
};
